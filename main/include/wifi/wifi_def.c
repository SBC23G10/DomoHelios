...
#define EXAMPLE_ESP_SERVER_SSID      "esp6838"
  ...
  //  ESP_ERROR_CHECK(esp_event_loop_create_default());
    ...
    wifi_config_t wifi_config = {
        .ap = {
            ...
            .channel = EXAMPLE_ESP_SERVER_CHANNEL,
    ...
    ESP_LOGI(TAG_A, "wifi_init_softap finished. SSID:%s password:%s channel:%d",
             EXAMPLE_ESP_SERVER_SSID, EXAMPLE_ESP_SERVER_PASS, EXAMPLE_ESP_SERVER_CHANNEL);
}

void set_wifi_ok_addr(char *addr)
{
    wifi_ok = addr;
}